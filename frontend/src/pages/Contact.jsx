                ...
                {submitted ? (
                    ...
                    >
                        ...
                        <h2
                            ...
                            style={{ fontSize: "clamp(28px, 2.6vw, 36px)", lineHeight: 1.15, color: "var(--navy)", fontWeight: 600, letterSpacing: "-0.01em" }}
                        >
                    ...
                    >
                        ...
                        <p className="font-serif italic mt-5" style={{ fontSize: 14, color: "var(--steel)" }}>
